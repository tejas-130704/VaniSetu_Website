export default function ConclusionSection() {
  return (
    <section className="min-h-screen flex items-center justify-center py-20 px-4 bg-gradient-to-b from-black via-cyan-950/40 to-teal-950/20 relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute top-20 left-20 w-72 h-72 bg-cyan-600/20 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-20 right-20 w-72 h-72 bg-teal-600/20 rounded-full blur-3xl animate-pulse" />

      <div className="relative z-10 text-center max-w-3xl mx-auto">
        <h2 className="text-4xl md:text-6xl font-bold mb-8 gradient-text leading-tight text-balance">
        ...
        <div className="mb-12">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            ...
            <button className="px-8 py-3 rounded-full bg-gradient-to-r from-cyan-500 to-teal-500 text-white font-semibold hover:shadow-lg hover:neon-glow transition-all">
              Get in Touch
            </button>
          </div>
        </div>
